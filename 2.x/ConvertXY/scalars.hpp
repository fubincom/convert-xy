...
#define CONVERT_XY_PRIM_TO_CPP_DEFAULTS(type) \
 ...
 template <> \
  ...
  CONVERTXY_DEFINE_SIMPLE_TYPE_STRING_LAYER(bool, "bool", 0);
  CONVERT_XY_PRIM_TO_CPP_DEFAULTS(unsigned char);
  CONVERTXY_DEFINE_SIMPLE_TYPE_STRING_LAYER(unsigned char, "unsigned char", 0);
  CONVERT_XY_PRIM_TO_CPP_DEFAULTS(char);
  CONVERTXY_DEFINE_SIMPLE_TYPE_STRING_LAYER(char, "char", 0);
  CONVERT_XY_PRIM_TO_CPP_DEFAULTS(unsigned int);
  CONVERTXY_DEFINE_SIMPLE_TYPE_STRING_LAYER(unsigned int, "unsigned int", 0);
  CONVERT_XY_PRIM_TO_CPP_DEFAULTS(int);
  CONVERTXY_DEFINE_SIMPLE_TYPE_STRING_LAYER(int, "int", 0);
  CONVERT_XY_PRIM_TO_CPP_DEFAULTS(unsigned short);
  CONVERTXY_DEFINE_SIMPLE_TYPE_STRING_LAYER(unsigned short, "unsigned short", 0);
  CONVERT_XY_PRIM_TO_CPP_DEFAULTS(short);
  CONVERTXY_DEFINE_SIMPLE_TYPE_STRING_LAYER(short, "short", 0);
  CONVERT_XY_PRIM_TO_CPP_DEFAULTS(unsigned long);
  CONVERTXY_DEFINE_SIMPLE_TYPE_STRING_LAYER(unsigned long, "unsigned long", 0);
  CONVERT_XY_PRIM_TO_CPP_DEFAULTS(long);
  CONVERTXY_DEFINE_SIMPLE_TYPE_STRING_LAYER(long, "long", 0);
  CONVERT_XY_PRIM_TO_CPP_DEFAULTS(float);
  CONVERTXY_DEFINE_SIMPLE_TYPE_STRING_LAYER(float, "float", 0);
  CONVERT_XY_PRIM_TO_CPP_DEFAULTS(double);
  CONVERTXY_DEFINE_SIMPLE_TYPE_STRING_LAYER(double, "double", 0);
